...
class LinkedListTest {	//make sure that you dont name class as a LinkedList only it will not compile
	...
	//
	//IMP Note->1.LinkedList allow us to enter duplicate values
	//	2.LinkedList maintains insertion order means it will print exactly how you entered values
	//	3.LinkedList works on node and reference mechanism
